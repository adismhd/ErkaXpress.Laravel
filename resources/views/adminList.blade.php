            ...
            <form action="TambahUser" method="post">
                ...
                <div class="modal-body">
                    <div class="col-md-12 mt-3">
                        ...
                        <input type="text" name="namaUser" class="form-control" id="inNama" required>                    
                    </div>
                    <div class="col-md-12 mt-3">
                        <label>Email <i style="color: crimson">*</i></label>
                        <input type="email" name="emailUser" class="form-control" id="inEmail" required>                    
                    </div>
                    <div class="col-md-12 mt-3">
                        <label>Password <i style="color: crimson">*</i></label>
                        <input type="password" name="passwordUser" class="form-control" id="inPassword" required>                    
                    </div>
                </div>
